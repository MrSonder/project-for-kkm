...
void driveMotorForSeconds(double seconds, int L, int R);
...
String driveStepper(int steps, char direction);
String int_to_XXX_Stepper(int speedInt);
...
String driveStepper(int steps, char direction, char on_off)
{
    ostringstream stringStream;
    stringStream << "X" << int_to_XXX_Stepper( steps ) << direction << "000" << on_off;
    string stepsString = stringStream.str();
    return stepsString;
}
